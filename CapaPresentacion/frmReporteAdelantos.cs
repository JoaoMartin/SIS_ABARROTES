...
{
    public partial class frmReporteAdelantos : Form
    {
        public static frmReporteAdelantos f1;
        public frmReporteAdelantos()
        {
            InitializeComponent();
            frmReporteAdelantos.f1 = this;
        }
        ...
        private void frmReporteAdelantos_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
            cbEmpleado.SelectedIndex = -1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.dataListado.DataSource = NAdelanto.reporteAdelanto(Convert.ToDateTime(fechaInicio), Convert.ToDateTime(fechaFin),cbEstado.Text,idTrabajador);
        ...
        {
            frmRAdelantos frm = new frmRAdelantos();
            frm.ShowDialog();
        }
    }
}
