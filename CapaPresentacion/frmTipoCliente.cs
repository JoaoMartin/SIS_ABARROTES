...
namespace CapaPresentacion
{
    public partial class frmTipoCliente : Form
    {
        ...
        private void dataListado_Click(object sender, EventArgs e)
        {
            ...
            this.txtNombre.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["TipoCliente"].Value);
            this.txtDescripcion.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Descr"].Value);
        }
