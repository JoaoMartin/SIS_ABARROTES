...
{
    public partial class frmTipoMovAlmacen_Ingreso : Form
    {
        public frmTipoMovAlmacen_Ingreso()
        {
            InitializeComponent();
        ...
        private void frmTipoMovAlmacen_Ingreso_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
        ...
        private void frmTipoMovAlmacen_Ingreso_FormClosed(object sender, FormClosedEventArgs e)
        {
