...
namespace CapaPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void ocultarColumnas()
        {
            ...
            this.dataListado.Columns[3].Width = 152;
            this.dataListado.Columns[4].Width = 294;
        ...
        private void Guardar()
        {
            try
            {
                ...
                else if (this.cbMarca.SelectedIndex == -1 && rbProducto.Checked == true)
                {
