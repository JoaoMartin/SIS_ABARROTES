...
{
    public partial class frmRMovCaja : Form
    {
        public frmRMovCaja()
        {
            InitializeComponent();
        ...
        private void frmRMovCaja_Load(object sender, EventArgs e)
        {
            try
            {
                string bandera = frmReporteMovCaja.f1.lblBandera.Text;
                string fechaInicio = "";
                string fechaFin = "";
                DateTime fecIn;
                if (bandera == "1")
                {
                    fechaInicio = frmReporteMovCaja.f1.dtpFechaInicio.Value.ToString("yyyy-MM-dd" + " 00:00:00");
                    fechaFin = frmReporteMovCaja.f1.dtpFechaFin.Value.ToString("yyyy-MM-dd" + " 23:59:59");
                }
                else
                {
                ...
                repdoc.Load(@"D:\Reportes\RCaja.rpt");
