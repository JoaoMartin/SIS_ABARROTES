...
{
    public partial class frmRPlato : Form
    {
        public frmRPlato()
        {
            InitializeComponent();
        ...
        private void frmRPlato_Load(object sender, EventArgs e)
        {
            try
            {
               ...
               // repdoc.Load(@"C:\Users\vioma\OneDrive\Documentos\Visual Studio 2017\Projects\SisVentas_ResAlm\CapaPresentacion\Reportes/RPlatos.rpt");
