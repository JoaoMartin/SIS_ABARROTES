...
namespace CapaPresentacion
{
    public partial class frmMarca : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(this.txtNombre, "Ingrese el Nombre de la Marca");
        }
        ...
        private void Buscar()
        {
            this.dataListado.DataSource = NMarca.Buscar(this.txtBuscar.Text.Trim());
            this.ocultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void Guardar()
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NMarca.Insertar(this.txtNombre.Text.Trim().ToUpper(), "A");
                    }
                    else
                    {
                        rpta = NMarca.Editar(Convert.ToInt32(this.txtIdMarca.Text), this.txtNombre.Text.Trim().ToUpper(), "A");
                    }
        ...
        private void dataListado_Click(object sender, EventArgs e)
        {
            ...
            this.btnCancelar.Enabled = true;
            this.txtIdMarca.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Codigo"].Value);
            this.txtNombre.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Marca"].Value);
        }
